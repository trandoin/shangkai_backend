...
# from clients.serializers import UserRegisterSerializer #,UserTokenAuthSerializer
# from clients.models import User_Register #,user_token_authentication
...
# from token_authentication.utils import generate_access_token, generate_refresh_token
...
#     user= user_token_authentication.objects.filter(user_phonenumber=phone_number)
...
#     serialized_user=UserTokenAuthSerializer(user,many=True)
#     for usr in user:
