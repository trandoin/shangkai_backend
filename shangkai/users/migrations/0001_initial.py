    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('datetime', models.DateTimeField(auto_now_add=True, verbose_name='Created At')),
                ('no_guests', models.CharField(max_length=255, null=True, verbose_name='no_guests')),
                ('booking_date', models.DateField(default='2021-03-09', max_length=255, null=True, verbose_name='booking_date')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(default='0', max_length=255, null=True, verbose_name='status')),
                ('cart_id', models.ForeignKey(db_constraint=False, default=None, on_delete=django.db.models.deletion.CASCADE, to='users.user_hotspots_cart')),
                ('user', models.ForeignKey(db_constraint=False, default=None, on_delete=django.db.models.deletion.CASCADE, to='users.normal_userreg')),
            ],
            options={
